const words = new Set([
    ...
    "Let’s catch up soon and grab a coffee.",
    "Thank you for your help with that project; I really appreciate it!",
    "I’m so excited about the upcoming event!",
    "Please let me know if there’s anything else I can do to assist you.",
    "It’s been great working with you on this so far.",
    "I’ll be sure to follow up with you next week about the next steps.",
]);
